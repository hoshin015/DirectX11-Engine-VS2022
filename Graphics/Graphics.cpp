...
#pragma endregion
	...
	D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		{
			"POSITION",		// セマンティック名
			0,				// 同じセマンティック名が存在するときに区別するためのindex
			DXGI_FORMAT::DXGI_FORMAT_R32G32B32_FLOAT, // 要素のデータ型(何個の情報を渡すかみたいな)
			0,				// 入力アセンブラーを識別する整数値
			0,				// 頂点の始点からのオフセット(先頭なので0)
			D3D11_INPUT_CLASSIFICATION::D3D11_INPUT_PER_VERTEX_DATA,	// 入力レイアウトに含まれるデータの種類(頂点ごとのデータ)
			0
		},
